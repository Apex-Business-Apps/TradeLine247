  ...
  return (
    <section className="hero-section text-center overflow-hidden pt-safe pb-safe px-safe"  style={{ 
      ...
      <div className="container relative z-10">
        ...
        <h1 className="hero-headline text-3xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight animate-fade-in [animation-delay:200ms]">
          Your 24/7 Ai Receptionist
        </h1>
        
        {/* Value Proposition with Delayed Animation */}
        <p className="hero-tagline text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in [animation-delay:400ms]">
        ...
        <div className="space-y-4 mt-12 animate-fade-in [animation-delay:600ms]">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="hero-cta-button text-primary-foreground text-xl px-12 py-6 rounded-full transition-all duration-300 hover-scale" 
