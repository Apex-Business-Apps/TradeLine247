...
const docsLinks: DocLink[] = [
  {
    ...
    sourceUrl: 'https://github.com/Apex-Business-Apps/TradeLine247/blob/main/README.md',
  },
  {
    ...
    sourceUrl: 'https://github.com/Apex-Business-Apps/TradeLine247/blob/main/docs/archive/telephony/TWILIO_VOICE_README.md',
  },
];
